...
<div class="note">
<strong>📘 Note:</strong> *E. coli* MG1655 is a prokaryote. Key differences to keep in mind: - No introns → transcript = gene (tx2gene mapping is 1:1) - Use **org.EcK12.eg.db** for annotation or **EcK12** KEGG pathways - Genome size \~4.6 Mb with \~4,300 genes - Enrichment analysis via KEGG or custom gene sets with **fgsea**
</div>
